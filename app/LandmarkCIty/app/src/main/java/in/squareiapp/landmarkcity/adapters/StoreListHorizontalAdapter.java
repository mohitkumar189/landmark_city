...
public class StoreListHorizontalAdapter extends RecyclerView.Adapter<StoreListHorizontalAdapter.MyViewHolder> {
    private final String TAG = getClass().getSimpleName();
    private CustomItemClickListener customItemClickListener;
    private List<StoreData> usersPostsData;
    private Context context;

    public StoreListHorizontalAdapter(CustomItemClickListener customItemClickListener, List<StoreData> usersPostsData, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(context)
                .inflate(R.layout.row_store_suggestion, parent, false);
        return new StoreListHorizontalAdapter.MyViewHolder(itemView);
    }
